                ...
                <c:forEach var="file" items="${requestScope.files}">
                    <div class="file">
                        ...
                        <div class="file-icon-div">
                            ...
                            <c:if test="${file.id_FileType == 10}"><span class="pptx-icon"></span></c:if><c:if test="${file.id_FileType == 11}"><span class="png-icon"></span></c:if>
                            <c:if test="${file.id_FileType == 12}"><span class="jpg-icon"></span></c:if><c:if test="${file.id_FileType == 13}"><span class="unknown-file-icon"></span></c:if>
                        </div>
