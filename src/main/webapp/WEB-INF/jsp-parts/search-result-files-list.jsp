...
<c:if test="${(not empty requestScope.files)}">
    <div class="files-view">
        <div class="files-info-box" id="files-info-box">
            ...
            <div class="file-info-box-list" id="file-info-box-list">
                <div class="file-info-list" id="file-info-list">
                    <c:if test="${!(not empty requestScope.files)}">
                        <div class="no-files">
                        </div>
                    </c:if>
                    ...
                    <c:forEach var="file" items="${requestScope.files}">
                        <div class="file-list">
                            <input type="hidden" class="file-id-list" value="${file.id_File}">
                            <div class="file-icon-div-list">
                            ...
                            <div class="file-name-list"><span>${file.name}</span></div>
                        </div>
                    </c:forEach>
                </div>
            </div>
