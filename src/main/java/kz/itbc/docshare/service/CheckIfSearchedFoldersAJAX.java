...
public class CheckIfSearchedFoldersAJAX implements Service {
    @Override
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if(currentPage != null){
            if(!currentPage.isDepartment() && currentPage.getId() == SEARCH_PAGE_ID){
                message.put(CURRENT_PAGE_ATTRIBUTE, "searchedFolders");
            } else{
                message.put(CURRENT_PAGE_ATTRIBUTE, "notsearchedFolders");
