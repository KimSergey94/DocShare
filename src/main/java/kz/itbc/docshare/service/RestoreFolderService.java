...
public class RestoreFolderService implements Service {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException  {
        ...
        if(  (folder.getUserCreated().getId_User() == user.getId_User()) || (user.getId_Role() == 2 || user.getId_Role() == 3)  ) {
            try {
                ...
                SERVICE_LOGGER.error("Ошибка восстановления папки.");
            } catch (FileDAOException e) {
                SERVICE_LOGGER.error("Ошибка восстановления файлов папки.");
            }
        }
